...
#define TIM1_STOP      TCCR1B &= ~((1<<CS12) | (1<<CS11) | (1<<CS10)); //binární maska 0000 0111 -> 1111 1000 (negace)
...
/** @brief Stop timer, prescaler 000 --> STOP */
#define TIM0_STOP       TCCR0B &= ~((1<<CS12) | (1<<CS11) | (1<<CS10)); //binární maska 0000 0111 -> 1111 1000 (negace)
...
/** @brief Set overflow 16400s, prescaler // 101 --> 1024 */
#define TIM0_OVF_16400US  TCCR0B &= ~(1<<CS11); TCCR0B |= (1<<CS12) | (1<<CS10);
...
// WRITE YOUR CODE HERE
/** @brief Stop timer, prescaler 000 --> STOP */
#define TIM2_STOP      TCCR2B &= ~((1<<CS12) | (1<<CS11) | (1<<CS10)); //binární maska 0000 0111 -> 1111 1000 (negace)
/** @brief Set overflow 4ms, prescaler 001 --> 1 */
#define TIM2_OVF_16US   TCCR2B &= ~((1<<CS12) | (1<<CS11)); TCCR2B |= (1<<CS10);
/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define TIM1_OVF_128US  TCCR2B &= ~((1<<CS12) | (1<<CS10)); TCCR2B |= (1<<CS11);
/** @brief Set overflow 33ms, prescaler 011 --> 32 */
#define TIM1_OVF_512US  TCCR2B &= ~((1<<CS12)); TCCR2B |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 262ms, prescaler 100 --> 64 */
#define TIM1_OVF_1024US TCCR2B &= ~(1<<CS11) | (1<<CS10); TCCR2B |= (1<<CS12);
/** @brief Set overflow 33ms, prescaler 101 --> 128 */
#define TIM1_OVF_2050US  TCCR2B &= ~((1<<CS11)); TCCR2B |= (1<<CS12) | (1<<CS10);
/** @brief Set overflow 1s, prescaler 110 --> 256 */
#define TIM1_OVF_4096US  TCCR2B &= ~((1<<CS10)); TCCR2B |= (1<<CS12) | (1<<CS11);
/** @brief Set overflow 4s, prescaler // 111 --> 1024 */
#define TIM1_OVF_16400US  TCCR2B &= TCCR2B |= (1<<CS12) | (1<<CS11) | (1<<CS10);

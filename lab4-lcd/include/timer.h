...
#define TIM2_OVF_512US  TCCR2B &= ~((1<<CS12)); TCCR2B |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 262ms, prescaler 100 --> 64 */
#define TIM2_OVF_1024US TCCR2B &= ~(1<<CS11) | (1<<CS10); TCCR2B |= (1<<CS12);
/** @brief Set overflow 33ms, prescaler 101 --> 128 */
#define TIM2_OVF_2050US  TCCR2B &= ~((1<<CS11)); TCCR2B |= (1<<CS12) | (1<<CS10);
/** @brief Set overflow 1s, prescaler 110 --> 256 */
#define TIM2_OVF_4096US  TCCR2B &= ~((1<<CS10)); TCCR2B |= (1<<CS12) | (1<<CS11);
/** @brief Set overflow 4s, prescaler // 111 --> 1024 */
#define TIM2_OVF_16400US  TCCR2B &= TCCR2B |= (1<<CS12) | (1<<CS11) | (1<<CS10);
